...
$sql1 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM government_offices ORDER BY gid";
$sql2 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM post_offices ORDER BY gid";
$sql3 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM electric_substations ORDER BY gid";
$sql4 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM telegraph_office ORDER BY gid";
