...
$sql1 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM hospital ORDER BY gid";
$sql2 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM clinics ORDER BY gid";
$sql3 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM diagnostic_center ORDER BY gid";
$sql4 = "SELECT *,ST_AsGeoJSON(the_geom) as geom FROM veterinary ORDER BY gid";
